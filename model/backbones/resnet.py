...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,use_bap=False):
...
class ResNet(nn.Module):
    def __init__(self, last_stride=2, block=Bottleneck,use_bap=False, layers=[3, 4, 6, 3]):
        self.inplanes = 64
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=last_stride,use_bap=use_bap)

    def _make_layer(self, block, planes, blocks, stride=1,use_bap=False):
        downsample = None
        self.use_bap=use_bap
        ...
        layers.append(block(self.inplanes, planes,use_bap=use_bap))
        if use_bap:
